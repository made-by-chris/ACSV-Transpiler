...
// col_name--STOP - stop the accumulation of col_name--.
export var ASCV_Operator;
(function (ASCV_Operator) {
    ASCV_Operator["ASSIGN"] = "=";
    ASCV_Operator["PLUS"] = "+";
    ASCV_Operator["MINUS"] = "-";
    ASCV_Operator["PLUSPLUS"] = "++";
    ASCV_Operator["MINUSMINUS"] = "--";
    ASCV_Operator["STOP"] = "STOP";
})(ASCV_Operator || (ASCV_Operator = {}));
...
var Line_Type;
(function (Line_Type) {
    Line_Type["control_indicator"] = "control_indicator";
    Line_Type["comment"] = "comment";
    Line_Type["control"] = "control";
    Line_Type["data"] = "data";
})(Line_Type || (Line_Type = {}));
export default (config = { input: "ERR_ACSV transpiler input missing", streaming: false, streaming_callback: console.log, stats: true, stats_callback: console.log }) => {
    ...
    const output_lines_as_cell_lists = [];
    const all_column_names = input_lines[0].split(",");
    const controlled_columns_state = {}; // contains the current value of a column, if it is an ACSV stateful column
    if (stats) {
        const stats_output = {
    ...
    function handle_control_line(line) {
    ...
    function handle_data_line(line) {
